                        ...
                        <div class="grid grid-cols-2 gap-2 text-sm">
                            ${product.category_name ? `
                                <div>
                                    ...
                                    <a href="/sundarta/products?category=${product.category_id}" class="text-primary hover-link ml-1">${product.category_name}</a>
                                </div>
                            ` : ''}
                ...
                <div class="tab-content hidden" id="tab-specifications">
                    <div class="overflow-x-auto">
                        <table class="w-full border-collapse">
                            <tbody>
                                ${product.specifications ? product.specifications.split('|').map(spec => {
                                    const [key, value] = spec.split(':').map(s => s.trim());
                                    return `
                                        <tr class="border-b">
                                            <td class="py-2 px-4 bg-sand-light font-medium">${key}</td>
                                            <td class="py-2 px-4">${value}</td>
                                        </tr>
                                    `;
                                }).join('') : `
                                    <tr>
                                        <td colspan="2" class="py-4 text-center text-text-light">
